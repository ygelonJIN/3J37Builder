...
class _AttributeControlState extends State<_AttributeControl> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool shouldLock = isMaxed || widget.isLocked;
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                ...
                child: Text.rich(
                  TextSpan(children: [
                    TextSpan(text: '${widget.value}', style: AppTokens.body.copyWith(color: xColor, fontSize: 12)),
                    TextSpan(text: '/${widget.cap}', style: AppTokens.body.copyWith(color: yColor, fontSize: 12)),
                  ]),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: widget.isLocked ? AppTokens.primary.withValues(alpha: 0.5) : AppTokens.keyOff.withValues(alpha: 0.3), width: 1),
                    borderRadius: BorderRadius.circular(AppTokens.radius),
                  ),
                  child: Icon(shouldLock ? Icons.lock : Icons.lock_open, size: 14, color: widget.isLocked ? AppTokens.primary : AppTokens.keyOff.withValues(alpha: 0.5)),
                ),
              ),
            ],
          ),
          ...
          Row(children: List.generate(5, (index) {
            ...
            return Expanded(
              child: Container(
                ...
                child: Center(child: isUsable && gain != null ? Text('+${gain.gain}', style: AppTokens.caption.copyWith(fontSize: 10, color: AppTokens.primary, fontWeight: FontWeight.w600)) : Icon(Icons.lock, size: 12, color: AppTokens.keyOff)),
              ),
            );
          })),
        ],
